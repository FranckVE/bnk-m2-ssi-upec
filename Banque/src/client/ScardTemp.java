...
// client d = private exponent
final byte[] clientPrivateExponent = new byte[] {
		 (byte)0x2a, (byte)0x6e, (byte)0x14, (byte)0xf3, (byte)0x8e, (byte)0x61, (byte)0x24, (byte)0x63,
...
//Bank e = publicExponent
	final byte[] bankPublicExponent = new byte[] { (byte) 0x01, (byte) 0x00,
			(byte) 0x01 };
	

	public byte[] sign(String passwd) {
		 
		 CryptoUtils util = new CryptoUtils() ;
		 RSAPrivateKey privKey = (RSAPrivateKey) util.getRSAPrivateKey(clientPrivateExponent, clientPublicModulus);
		return  util.signSHA1(passwd, (java.security.interfaces.RSAPrivateKey) privKey);
	}

	public byte[] getBanqueModulus() {
		return bankPublicModulus;
	}
	...
	public void waittingForCard(){
		
	}

	public int enterPin(char [] tab){
		return 1 ;
	}
}
